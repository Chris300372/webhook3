...
SYSTEM_PROMPT_RESERVAS = (
    ...
    "Despues de enviar la resolucion pidele al usuario que te confirme si pudo solucionar el problema con las indicaciones proporcionadas, en caso contrario indica que se escalara a soporte L2."
)
